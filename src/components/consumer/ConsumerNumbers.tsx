...
const STATS = [
  ...
  { value: 25, suffix: "%", label: "Economia média mensal" },
  { value: 96, prefix: "R$", suffix: "K", label: "Economia gerada em 2024" },
  { value: 98, suffix: "%", label: "Satisfação dos clientes" },
];

export default function ConsumerNumbers() {
  return (
      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <ScrollReveal delay={0.1}>
            <p className="text-base text-white/40 leading-relaxed">
              Resultados concretos que demonstram o impacto positivo da PagLuz para nossos consumidores.
            </p>
          </ScrollReveal>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {STATS.map((stat, i) => (
            ...
            >
              <div className="text-4xl md:text-5xl font-bold font-display text-gradient mb-3">
