...
export default function GeneratorCtaBanner() {
  return (
        ...
        <ScrollReveal>
          ...
          >
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
              ...
              <div className="absolute bottom-0 left-0 w-96 h-96 bg-brand-green/[0.05] rounded-full -translate-x-1/3 translate-y-1/3 blur-[100px]" />
            </div>
            
            <div className="relative z-10 text-center flex flex-col items-center">
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6 font-display">
                Maximize a rentabilidade da sua <span className="text-gradient">usina</span>
              </h2>
              <p className="text-white/40 text-base md:text-lg max-w-2xl mx-auto mb-10 font-light leading-relaxed">
                Junte-se a dezenas de geradores que já estão otimizando seus rendimentos e contribuindo para um futuro mais sustentável com a PagLuz.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                ...
                >
                  <span>Cadastrar minha usina</span>
